...
try:
	...
	master = Tk()
	red = Scale(master, from_=0, to=255, orient=HORIZONTAL, label= "Red", command=show_values)
	red.pack()
	green = Scale(master, from_=0, to=255, orient=HORIZONTAL, label= "Green", command=show_values)
	green.pack()
	blue = Scale(master, from_=0, to=255, orient=HORIZONTAL, label= "Blue", command=show_values)
	blue.pack()
	mainloop()
